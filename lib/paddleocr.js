...
/* Image decoding lives in lib/imageInput.js so that the ChatGPT engine can use it
   WITHOUT importing this file — the two engines must stay independent.
   Re-exported here so existing importers keep working. */
import { readImageInput, extForMime } from "@/lib/imageInput";
export { readImageInput, extForMime };
